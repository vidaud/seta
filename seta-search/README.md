...
The **seta-search**  folder contains the image with the python client that helps to communicates with the docker client in order to elaborate the queries to the Elasticsearch engine that comes from the web app. 
