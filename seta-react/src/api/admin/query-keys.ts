export class AdminQueryKeys {
  public static readonly SidebarQueryKey = ['sidebar-stats']

  public static readonly CommunityRequestsQueryKey = ['admin-pending-community-requests']
