                ...
                <div>
                    <div className="p-fluid grid">
                        ...
                        <div className='publicKey'>
                            <div className="field col-12 md:col-6">
                                <span className="p-float-label">
                                <InputTextarea id="publicKey" value={publicKey ? publicKey : defaultNoPublicKeyMessage} rows={22} cols={50} autoResize disabled/>
                                    <label htmlFor="publicKey">Public Key</label>
                                </span>
                            </div>
                            <Button icon="pi pi-trash" className="p-button-rounded p-button-text" aria-label="Delete Public Key" onClick={deleteRsaKey} />
                            <Button icon="pi pi-refresh" className="p-button-rounded p-button-text" aria-label="Refresh Public Key" onClick={generateRsaKeys} />
                        </div>
                    </div>
                    <div>
                        <Button icon='pi pi-user' className='p-button-icon-left' onClick={deleteUser}><span>Delete User</span></Button>
                    </div>
                </div>
            </div>
    </div>
