...
type Props = {
  ...
  firstElement?: CommunityResponse
}

const CommunityInfo = ({ community, community_scopes, firstElement }: Props) => {
  ...
  return (
    <div css={S.root} className={openClass}>
      ...
      >
        ...
        <div id={firstElement?.community_id === community_id ? 'join_community' : undefined}>
