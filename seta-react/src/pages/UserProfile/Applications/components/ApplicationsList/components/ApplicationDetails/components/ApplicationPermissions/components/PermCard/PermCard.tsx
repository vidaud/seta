...
import { useApplicationContext } from '~/pages/UserProfile/common/contexts/application-permissions-context'

import type { ApplicationPermissions } from '~/api/types/applications-permissions-types'
import { useUpdateApplicationsPermissions } from '~/api/user/applications-permissions'
