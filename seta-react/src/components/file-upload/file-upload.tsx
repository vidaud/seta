...
export const FileUploads = ({onChange}) => {
    ...
    const headerTemplate = (options) => {
        ...
        const formatedValue = fileUploadRef && fileUploadRef.current ? totalSize : '0 B';
        ...
        return (
            <div className={className} style={{backgroundColor: 'transparent', display: 'flex', alignItems: 'center'}}>
                ...
                {uploadButton}
                {cancelButton}
                <ProgressBar value={value} displayValueTemplate={() => `${formatedValue} / 5 MB`} style={{width: '300px', height: '20px', marginLeft: 'auto'}}></ProgressBar>
            </div>
        );
    }
    ...
    return (
        <div>
            <div className="card">
                ...
                <FileUpload ref={fileUploadRef} name="file_upload" url="https://primefaces.org/primereact/showcase/upload.php" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" maxFileSize={5000000}
