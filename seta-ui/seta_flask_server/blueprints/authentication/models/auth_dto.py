...
login_info_model = Model("LoginInfo", {
...
authenticators_model = Model("Authenticators",{
    "name": fields.String(description="Third-party authenticator", 
                          enum=[ExternalProviderConstants.ECAS.lower(), 
