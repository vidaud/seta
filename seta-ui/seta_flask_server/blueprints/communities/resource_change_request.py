...
from .models.resource_request_dto import(new_change_request_parser, change_request_model, user_info_model)
...
@resource_change_request_ns.route('/<string:resource_id>/change-requests/<string:request_id>', methods=['GET'])
@resource_change_request_ns.param("resource_id", "Resource identifier") 
