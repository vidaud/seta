...
@permissions_ns.route(
    ...
    endpoint="community_permission_list",
    methods=["GET"],
)
...
class CommunityPermissionList(Resource):
    ...
    @permissions_ns.doc(
        description="Retrieve full user-scope list for this community.",
        responses={
    ...
    def get(self, community_id):
        ...
        scopes = self.permissions_broker.get_all_community_scopes(
            community_id=community_id
        )
...
@permissions_ns.route(
    "/community/<string:community_id>/user/<string:user_id>",
    endpoint="community_user_permissions",
    methods=["GET", "POST"],
)
@permissions_ns.param("community_id", "Community identifier")
...
class CommunityUserPermissions(Resource):
    ...
    @permissions_ns.doc(
        description="Retrieve community permissions for a member.",
        responses={
            int(HTTPStatus.OK): "'Retrieved permissions list.",
    ...
    @permissions_ns.doc(
        description="Manage community permissions for a member",
        responses={
    ...
    @permissions_ns.expect(dto.community_scopes_parser)
    @jwt_required()
    def post(self, community_id, user_id):
        ...
        request_dict = dto.community_scopes_parser.parse_args()
        ...
        self.permissions_broker.replace_all_user_community_scopes(
            user_id=user_id, community_id=community_id, scopes=scopes
        )
