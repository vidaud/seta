...
discover_community_model = Model(
    "DiscoverCommunity",
    {
        ...
        "status": fields.String(
            description="The community status", enum=DiscoverCommunityStatus.List
        ),
        "created_at": fields.DateTime(description="Creation date"),
        "pending_invite": fields.Nested(
            model=invite_model,
            description="Pending invite, in case of 'invited' status",
            skip_none=True,
        ),
        "membership_request": fields.Nested(
            model=request_model,
            description="Pending request, in case of 'pending' or 'rejected' status",
            skip_none=True,
        ),
    },
)

discover_resource_model = Model(
    "DiscoverResource",
    {
