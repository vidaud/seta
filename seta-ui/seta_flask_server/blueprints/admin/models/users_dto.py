...
user_info_model = Model(
    "UserInfo",
    {
        ...
        "status": fields.String(
            description="Account status", enum=UserStatusConstants.List
        ),
    },
)
...
account_model = Model(
    "AccountInfo",
    {
        ...
        "externalProviders": fields.List(
            fields.Nested(provider_model), description="External providers"
        ),
        "details": fields.Nested(account_details_model, description="Account details"),
        "scopes": fields.Nested(
            user_scopes_model, description="User scopes", skip_none=True
        ),
    },
)
