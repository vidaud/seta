...
class SetaAccount(Resource):
    ...
    def get(self):
        ...
        for provider in user.external_providers:
            ep = {
                ...
                "is_current_auth": provider.provider
                == user.authenticated_provider.provider,
            }
    ...
    @account_info_ns.doc(
        description="Set account as deleted for this user.",
        responses={
    ...
    def delete(self):
        ...
        helpers.unset_token_info_cookies(response=response)
