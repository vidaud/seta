...
system_scope_model = Model(
    "SystemScope",
    {
        ...
        "scope": fields.String(
            description="System scope", enum=SystemScopeConstants.List
        ),
    },
)

community_scopes_model = Model(
    "CommunityScopes",
    {
        "community_id": fields.String(description="Identifier"),
        "scopes": fields.List(
            fields.String(description="Scope", enum=CommunityScopeConstants.List)
        ),
    },
)

resource_scopes_model = Model(
    "ResourceScopes",
    {
        "resource_id": fields.String(description="Identifier"),
        "scopes": fields.List(
            fields.String(description="Scope", enum=ResourceScopeConstants.List)
        ),
    },
)
...
user_scopes_model = Model(
    "UserScopeList",
    {
        ...
        "community_scopes": fields.List(
            fields.Nested(
                model=community_scopes_model,
                description="Community scopes",
                skip_none=True,
            )
        ),
        "resource_scopes": fields.List(
            fields.Nested(
                model=resource_scopes_model,
                description="Resource scopes",
                skip_none=True,
            )
        ),
    },
