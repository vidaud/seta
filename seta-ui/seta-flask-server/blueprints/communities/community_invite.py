...
from repository.models import CommunityInviteModel
from repository.interfaces import ICommunityInvitesBroker, IUsersBroker, ICommunitiesBroker
from infrastructure.decorators import auth_validator
from infrastructure.scope_constants import CommunityScopeConstants
from infrastructure.constants import InviteStatusConstants
...
class CommunityCreateChangeRequest(Resource):
    ...
    def get(self, community_id):
        ...
        if not any(cs.scope == CommunityScopeConstants.SendInvite for cs in user.community_scopes):
