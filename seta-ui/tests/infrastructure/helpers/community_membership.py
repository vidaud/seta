...
def create_membership_request(
    client: FlaskClient, access_token: str, community_id: str, message: str
):
    url = f"{API_V1}/communities/{community_id}/requests"
...
def update_membership_request(
    client: FlaskClient, access_token: str, community_id: str, user_id: str, status: str
):
...
def delete_membership(
    client: FlaskClient, access_token: str, community_id: str, user_id: str
):
